...
class pig_parameters_widget(QGroupBox):
    def __init__(self, act, ver, fileName="default_fog_parameters.json"):
        ...
        # screen_Geometry = screen_.geometry()
        # screen_Width = screen_Geometry.width()
        # screen_Height = screen_Geometry.height()
        # # 視窗大小
        # self.setGeometry(100, 100, screen_Width * 0.5, screen_Height * 0.6)
    ...
    def initUI(self):
        ...
        mainLayout.addWidget(self.dump_bt, 8, 0, 1, 2)
    ...
    def linkfunction(self):
        ...
        self.sf0.le.editingFinished.connect(lambda: self.selectcontrolchangecolor(self.sf0.le))
        self.sf1.le.editingFinished.connect(lambda: self.selectcontrolchangecolor(self.sf1.le))
        ...
        #self.loadTempFileBtn.clicked.connect()
