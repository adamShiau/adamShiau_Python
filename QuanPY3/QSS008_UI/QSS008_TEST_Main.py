...
import QSS008_TEST_Widget as UI
...
class mainWindow(QMainWindow):
	...
	def runAct(self):
		...
		self.top.plot.ax4.clear()
		self.top.plot.ax1.plot(error, color = 'blue', linestyle = '-', marker = '*', label = 'ERROR')
		self.top.plot.ax2.plot(int1st, color = 'red', linestyle = '-', marker = '*', label = '1st INT')
		self.top.plot.ax3.plot(int1st_div, color = 'green', linestyle = '-', marker = '*', label = '1st INT_Div')
		self.top.plot.ax4.plot(int2nd_div, color = 'blue', linestyle = '-', marker = '*', label = '2nd INT_Div')
		self.top.plot.ax1.legend(loc='upper right')
		self.top.plot.ax2.legend(loc='upper right')
		self.top.plot.ax3.legend(loc='upper right')
		self.top.plot.ax4.legend(loc='upper right')
