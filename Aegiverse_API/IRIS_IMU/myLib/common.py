...
def IRIS_IMU(dataPacket, EN=1, POS_TIME=25, sf_a=1, sf_b=0, PRINT=0):
    if EN:
        ...
        temp_fog1 = dataPacket[4:8]
        temp_fog2 = dataPacket[8:12]
        temp_fog3 = dataPacket[12:16]
        temp_ax = dataPacket[16:20]
        temp_ay = dataPacket[20:24]
        temp_az = dataPacket[24:28]
        temp_temperature1 = dataPacket[28:32]
        temp_temperature2 = dataPacket[32:36]
        temp_temperature3 = dataPacket[36:40]
        temp_acc_temp = dataPacket[40:44]
        temp_time = dataPacket[44:48]
