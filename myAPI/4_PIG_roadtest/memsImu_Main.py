...
from vboxReader import vboxReader, VBOX_DATA_STRUCTURE
...
class mainWindow(QMainWindow):
    ...
    def __init__(self, debug_en: bool = False):
        ...
        self.__vbox_connector = Connector()
        self.__isFileOpen = False
        self.top = TOP()
        self.act = ACTION()
        self.vbox = vboxReader()
        ...
        self.vboxdata = self.resetVBOXDataContainer()
    ...
    def linkfunction(self):
        ...
        self.vbox.vboxdata_qt.connect(self.collectVboxData)
    ...
    def connect(self):
        ...
        self.vbox.connect(self.__vbox_connector, 'COM11', 115200)
    ...
    def resetVBOXDataContainer(self):
    ...
    def collectVboxData(self, vboxdata):
        t0 = time.perf_counter()
        buf = self.vbox.readInputBuffer()
        self.vboxdata = vboxdata
        # print('vbox', t0, buf)
        # print(self.vboxdata)
