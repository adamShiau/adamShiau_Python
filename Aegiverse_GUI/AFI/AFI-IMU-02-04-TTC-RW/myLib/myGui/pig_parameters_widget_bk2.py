...
class pig_parameters_widget(QGroupBox):
    def __init__(self, act, fileName="default_fog_parameters.json"):
        ...
        self.dropdown_para.addItem(["1", "2", "3"])
        self.__chVal = int(self.dropdown_para.cb.currentText())
        ...
        self.KF_R.spin.setValue(50)  # 連接就會設定的值 20240415確認過，在不影響的狀況下是不會有問題
        self.linkfunction()
    ...
    def initUI(self):
        ...
        mainLayout.addWidget(self.sfb, 11, 6, 1, 2)
        mainLayout.addWidget(self.cutoff, 11, 0, 1, 2)
        mainLayout.addWidget(self.dump_bt, 12, 0, 1, 2)
        mainLayout.addWidget(self.Firmware_Version_lb, 13, 0, 1, 4)
        mainLayout.addWidget(self.GUI_Version_lb, 14, 0, 1, 4)
    ...
    def getVersion(self):
        ...
        self.GUI_Version_lb.setText('MF-12-EN')
