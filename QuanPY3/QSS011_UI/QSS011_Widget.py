...
class mainWidget(QWidget):
    def __init__(self, parent=None):
        ...
        self.main_UI()
        self.enableButtomsetting(False)
        self.start.setEnabled(False)
        self.stop.setEnabled(False)
        # self.getData.setEnabled(False)
        self.plot.ax.set_xlabel("dT (s)")
    ...
    def main_UI(self):
        ...
        mainLayout.addWidget(self.usb.layout2(), 0,1,1,6)
        ...
        mainLayout.addWidget(self.stop, 4,4,1,2)
    ...
    def enableButtomsetting(self, flag):
