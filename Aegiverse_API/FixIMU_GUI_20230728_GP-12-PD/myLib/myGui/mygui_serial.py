...
class usbConnect_auto_v2():
    def __init__(self, group_name='Connect COM port'):
        ...
        self.bt_update.setSizePolicy(QSizePolicy.Preferred, QSizePolicy.Fixed)
        self.bt_update.setMinimumSize(35, 10)
        self.cb.setSizePolicy(QSizePolicy.Preferred, QSizePolicy.Fixed)
        self.cb.setMinimumSize(35, 10)
        self.bt_connect.setSizePolicy(QSizePolicy.Preferred, QSizePolicy.Fixed)
        self.bt_connect.setMinimumSize(35, 10)
        self.bt_disconnect.setSizePolicy(QSizePolicy.Preferred, QSizePolicy.Fixed)
        self.bt_disconnect.setMinimumSize(35, 10)
    ...
    def addPortItems(self, num, ports):  # 更新COM Port使用的
        self.__portList = ports
        self.cb.clear()
        logger.debug('port_num: %d' % num)
        # logger.debug('ports: %s' % ports[0])
    ...
    def autoDetectStatusLabel(self, is_open):
        self.bt_connect.setEnabled(is_open)
        self.bt_disconnect.setEnabled(is_open)
