...
class memsImuWidget(QWidget):
    ...
    def initUI(self):
        ...
        self.para_block = lineEditBlock('parameter configuration file', le_name='gps_imu_para')
        ...
        layout.addWidget(self.buffer_lb, 1, 5, 1, 1)
        # layout.addWidget(self.pd_temp_lb, 1, 5, 1, 1)
        layout.addWidget(self.date_rb, 1, 4, 1, 1)
