...
class mainWindow(QMainWindow):
    ...
    def __init__(self, debug_en: bool = False):
        ...
        self.GUI_vers = "AFI-IMU-02-04-TTC-RW"
        self.setWindowTitle("Aegiverse GUI")
    ...
    def linkfunction(self):
        ...
        self.pig_menu.action_trigger_connect([self.show_version_menu,
    ...
    def update_kalFilter_en(self, rb):
        ...
        self.pig_menu.pig_kal_filter_action.setDisabled(not rb.isChecked())
    ...
    def connectMain(self):
        is_port_open = self.act.connectAct(self.__connector, self.__portName, 230400)
        if (is_port_open != False):
            ...
            self.top.kal_filter_rb.setDisabled(False)
            self.act.stopIMU()
        else:
            # 20231128
            self.act.stopIMU()
    ...
    def disconnectMain(self):
        ...
        self.top.kal_filter_rb.setDisabled(True)
        is_port_open = self.act.disconnectAct()
        self.is_port_open_qt.emit(is_port_open)
