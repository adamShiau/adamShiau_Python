...
class TabPlot(QTabWidget):
	def __init__(self, parent=None):
		...
		''' tab1 GUI item'''
		###tab1 plot###
		tab1_plot_w1 = self.win.addPlot(title="SRS200")
		self.tab1_plot_w1 = tab1_plot_w1.plot(pen='r')
		
		tab1_plot_a1 = self.win.addPlot(title="ADXL_x")
		self.tab1_plot_a1 = tab1_plot_a1.plot(pen='r')
		...
		# self.tab1_plot1_5 = tab1_plot1.plot(pen='m')
		self.win.nextRow()
		tab1_plot_w2 = self.win.addPlot(title="SPARROW")
		self.tab1_plot_w2 = tab1_plot_w2.plot(pen='b')
		
		tab1_plot_a2 = self.win.addPlot(title="ADXL_y")
		self.tab1_plot_a2 = tab1_plot_a2.plot(pen='b')
		...
		tab1_plot_w3 = self.win.addPlot(title="NANO33_x")
		self.tab1_plot_w3 = tab1_plot_w3.plot(pen='k')
		
		tab1_plot_a3 = self.win.addPlot(title="ADXL_z")
		self.tab1_plot_a3 = tab1_plot_a3.plot(pen='k')
		
		self.win.nextRow()
		
		tab1_plot_w4 = self.win.addPlot(title="NANO33_y")
		self.tab1_plot_w4 = tab1_plot_w4.plot(pen='g')
		
		self.win.nextRow()
		tab1_plot_w5 = self.win.addPlot(title="NANO33_z")
		self.tab1_plot_w5 = tab1_plot_w5.plot(pen='m')
		
		# tab1_plot3 = self.win.addPlot(title="speed(m/s)")
		# self.tab1_plot3_1 = tab1_plot3.plot(pen='r')
		# self.tab1_plot3_2 = tab1_plot3.plot(pen='b')
		# tab1_plot4= self.win.addPlot(title="VBOX_attitude(deg)")
		# self.tab1_plot4_1 = tab1_plot4.plot(pen='r')
		# self.tab1_plot4_2 = tab1_plot4.plot(pen='b')
		# self.tab1_plot4_3 = tab1_plot4.plot(pen='k')
		
		###tab1 check box###
		self.tab1_gyro_cb = chkBoxBlock_5('w','SRS200','PP', 'Nano33_wx', 'Nano33_wy', 'Nano33_wz')
		self.tab1_adxlXLM_cb = chkBoxBlock_3( 'a', 'ax', 'ay', 'az')
		self.tab1_nano33XLM_cb = chkBoxBlock_2('Nano33', 'ax', 'ay')
		self.tab1_speed_cb = chkBoxBlock_2('v', 'VBOX', 'IMU')
		self.tab1_attitude_cb = chkBoxBlock_3( 'attitude', 'roll', 'pitch', 'heading')
