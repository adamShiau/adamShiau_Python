...
class pig_calibration_widget(QGroupBox):
    ...
    def checkKeyExist(self, para, key):
        ...
        try:
            ...
            # logProcess.centrailzedError(num="", fileName=ExternalName_log, content=f"{e}--檢查key是否存在的判斷出現錯誤。", line=tb.tb_lineno)
            return 0
    ...
    def Send_G11_CMD(self):
        ...
        logProcess.centrailzedInfo(mes=f'set G11 : {float(self.W1_1.le.text())}', fileName=ExternalName_log)
    ...
    def Send_G12_CMD(self):
        ...
        logProcess.centrailzedInfo(mes=f'set G12 : {float(self.W1_2.le.text())}', fileName=ExternalName_log)
    ...
    def Send_G13_CMD(self):
        ...
        logProcess.centrailzedInfo(mes=f'set G13 : {float(self.W1_3.le.text())}', fileName=ExternalName_log)
    ...
    def Send_G21_CMD(self):
        ...
        logProcess.centrailzedInfo(mes=f'set G21 : {float(self.W2_1.le.text())}', fileName=ExternalName_log)
    ...
    def Send_G22_CMD(self):
        ...
        logProcess.centrailzedInfo(mes=f'set G22 : {float(self.W2_2.le.text())}', fileName=ExternalName_log)
    ...
    def Send_G23_CMD(self):
        ...
        logProcess.centrailzedInfo(mes=f'set G23 : {float(self.W2_3.le.text())}', fileName=ExternalName_log)
    ...
    def Send_G31_CMD(self):
        ...
        logProcess.centrailzedInfo(mes=f'set G31 : {float(self.W3_1.le.text())}', fileName=ExternalName_log)
    ...
    def Send_G32_CMD(self):
        ...
        logProcess.centrailzedInfo(mes=f'set G32 : {float(self.W3_2.le.text())}', fileName=ExternalName_log)
    ...
    def Send_G33_CMD(self):
        ...
        logProcess.centrailzedInfo(mes=f'set G33 : {float(self.W3_3.le.text())}', fileName=ExternalName_log)
    ...
    def Send_GX_CMD(self):
        # logger.info('set GX : %d', float(self.Wx.le.text()))
        logProcess.centrailzedInfo(mes=f'set GX : {float(self.Wx.le.text())}', fileName=ExternalName_log)
    ...
    def Send_GY_CMD(self):
        ...
        logProcess.centrailzedInfo(mes=f'set GY : {float(self.Wy.le.text())}', fileName=ExternalName_log)
    ...
    def Send_GZ_CMD(self):
        ...
        logProcess.centrailzedInfo(mes=f'set GZ : {float(self.Wz.le.text())}', fileName=ExternalName_log)
    ...
    def Send_A11_CMD(self):
        ...
        logProcess.centrailzedInfo(mes=f'set A11 : {float(self.A1_1.le.text())}', fileName=ExternalName_log)
    ...
    def Send_A12_CMD(self):
        ...
        logProcess.centrailzedInfo(mes=f'set A12 : {float(self.A1_2.le.text())}', fileName=ExternalName_log)
    ...
    def Send_A13_CMD(self):
        ...
        logProcess.centrailzedInfo(mes=f'set A13 : {float(self.A1_3.le.text())}', fileName=ExternalName_log)
    ...
    def Send_A21_CMD(self):
        ...
        logProcess.centrailzedInfo(mes=f'set A21 : {float(self.A2_1.le.text())}', fileName=ExternalName_log)
    ...
    def Send_A22_CMD(self):
        ...
        logProcess.centrailzedInfo(mes=f'set A22 : {float(self.A2_2.le.text())}', fileName=ExternalName_log)
    ...
    def Send_A23_CMD(self):
        ...
        logProcess.centrailzedInfo(mes=f'set A23 : {float(self.A2_3.le.text())}', fileName=ExternalName_log)
    ...
    def Send_A31_CMD(self):
        ...
        logProcess.centrailzedInfo(mes=f'set A31 : {float(self.A3_1.le.text())}', fileName=ExternalName_log)
    ...
    def Send_A32_CMD(self):
        ...
        logProcess.centrailzedInfo(mes=f'set A32 : {float(self.A3_2.le.text())}', fileName=ExternalName_log)
    ...
    def Send_A33_CMD(self):
        ...
        logProcess.centrailzedInfo(mes=f'set A33 : {float(self.A3_3.le.text())}', fileName=ExternalName_log)
    ...
    def Send_AX_CMD(self):
        ...
        logProcess.centrailzedInfo(mes=f'set AX : {float(self.Ax.le.text())}', fileName=ExternalName_log)
    ...
    def Send_AY_CMD(self):
        ...
        logProcess.centrailzedInfo(mes=f'set AY : {float(self.Ay.le.text())}', fileName=ExternalName_log)
    ...
    def Send_AZ_CMD(self):
        ...
        logProcess.centrailzedInfo(mes=f'set AZ : {float(self.Az.le.text())}', fileName=ExternalName_log)
