...
class pigImuWidget(QWidget):
    ...
    def initUI(self):
        ...
        self.plotrt = pgGraph_1_2(color1="w", color2="r", title="IMU VS GPS")
        ...
        layout.addWidget(self.speed_lb, 2, 10, 1, 1)
        layout.addWidget(self.head_lb, 2, 11, 1, 1)
        layout.addWidget(self.alt_lb, 2, 12, 1, 1)
        layout.addWidget(self.lat_lb, 2, 13, 1, 3)
        layout.addWidget(self.lon_lb, 2, 16, 1, 3)
        layout.addWidget(self.plotrt, 3, 10, 9, 9)
