...
class mainWindow(QMainWindow):
    ...
    def __init__(self, debug_en: bool = False):
        ...
        self.setWindowTitle("Aegiverse GUI (SG-AHRS-01-52-TTC-RW)")
    ...
    def connectMain(self):
        if self.__baudRate != "BaudRate(預設)":
            ...
            self.pig_parameter_widget = pig_parameters_widget(self.act, 'SG-AHRS-01-04-TTC-RW')
    ...
    def occurError(self, errStr: str):
        self.stop()
        self.disconnectMain()
        self.__logProc.centrailzedError(err="Info", content="An error occurred causing the GUI to stop and disconnect.", fileName=ExternalName_log)
