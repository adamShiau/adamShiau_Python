...
class mplGraph_1(QWidget):
    def __init__(self, parent=None, width=10, height=10, dpi=100):
        ...
        # chunksize = plt.rcParams['agg.path.chunksize']
        # print("Current 'agg.path.chunksize' value:", chunksize)
        # Increase the chunk size limit
        # plt.rcParams['agg.path.chunksize'] = 10000  # Set to a suitable value
