...
class pigImuWidget(QWidget):
    ...
    def initUI(self):
        ...
        self.sat_lb = displayOneBlock('Sats')
        ...
        layout.addWidget(self.plot2_showTrack_cb, 3, 18, 1, 2)
        ...
        layout.addWidget(self.lat_lb, 3, 10, 1, 4)
        layout.addWidget(self.lon_lb, 3, 14, 1, 4)
