...
def readMP_1Z_ATT(dataPacket, POS_WX, POS_WY, POS_WZ, POS_AX, POS_AY, POS_AZ, POS_TIME, POS_PDTEMP, POS_PITCH, POS_ROW, POS_YAW, dataLen, PRINT=0):
    temp_wx = dataPacket[POS_WX:POS_WX + dataLen]
    temp_wy = dataPacket[POS_WY:POS_WY + dataLen]
    temp_wz = dataPacket[POS_WZ:POS_WZ + dataLen]
    temp_ax = dataPacket[POS_AX:POS_AX + dataLen]
    ...
    return mcu_time, wx, wy, wz, ax, ay, az, pd_temp, pitch, row, yaw
