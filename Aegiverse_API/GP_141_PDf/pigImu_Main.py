...
class mainWindow(QMainWindow):
    ...
    def start(self):
        ...
        self.imudata_file.write_line('time,wx,wy,wz,ax,ay,az,T,pitch,row,yaw')
    ...
    def collectData(self, imudata):
        if not self.press_stop:
            ...
            self.printAtt(imudata["PITCH"][0], imudata["ROW"][0], imudata["YAW"][0])
            ...
            datalist = [imudata["TIME"], imudata["WX"], imudata["WY"], imudata["WZ"],
                        ...
                        imudata["PITCH"], imudata["ROW"], imudata["YAW"]]
