...
class pigImuWidget(QWidget):
    ...
    def initUI(self):
        ...
        layout.addWidget(self.save_block, 0, 8, 1, 2)
        ...
        layout.addWidget(self.buffer_lb, 1, 4, 1, 1)
        layout.addWidget(self.pd_temp_lb, 1, 7, 1, 1)
        layout.addWidget(self.data_rate_lb, 1, 5, 1, 2)
        layout.addWidget(self.logo_lb, 0, 10, 2, 10)
        ...
        layout.addWidget(self.pdX_temp_lb, 1, 8, 1, 1)
        layout.addWidget(self.pdY_temp_lb, 1, 9, 1, 1)
