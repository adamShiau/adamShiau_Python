...
class pigImuWidget(QWidget):
    ...
    def initUI(self):
        ...
        self.plot1 = pgGraph_1_3(color1="w", color2="r", color3="b",linename1="WX", linename2="WZ", linename3="WY", title="FOG　　  [unit: DPH]")
        ...
        self.plot7 = pgGraph_1_3(color1="w", color2="r", color3="b", linename1="AX", linename2="AY", linename3="AZ", title="MEMS      [unit: g]")
        self.plot1_lineName = checkBoxBlock_3("FOG Line Chart", "WX (White)", "WZ (Red)", "WY (Blue)")
        self.plot7_lineName = checkBoxBlock_3("MEMS Line Chart", "AX (White)", "AY (Red)", "AZ (Blue)")
