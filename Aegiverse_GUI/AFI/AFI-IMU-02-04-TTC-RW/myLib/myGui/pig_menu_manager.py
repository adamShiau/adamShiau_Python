...
class pig_menu_manager:
    ...
    def action_list(self, obj):
        self.pig_version_action = QAction("pig version")
        ...
        self.pig_kal_filter_action = QAction("setting Kalman")
        self.pig_kal_filter_action.setDisabled(True)
        ...
        self.setting_menu.addAction(self.pig_kal_filter_action)
    ...
    def action_trigger_connect(self, fn):
        self.pig_version_action.triggered.connect(fn[0])
        ...
        self.pig_initial_setting_action.triggered.connect(fn[3])
        self.pig_W_A_cali_action.triggered.connect(fn[4])
        self.pig_kal_filter_action.triggered.connect(fn[5])
