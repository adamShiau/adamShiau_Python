...
class pig_parameters_widget(QGroupBox):
    ...
    def initUI(self):
        ...
        mainLayout.addWidget(self.dac_Vpi, 5, 0, 1, 2)
        mainLayout.addWidget(self.rst_voltage, 5, 2, 1, 2)
        mainLayout.addWidget(self.err_th, 6, 0, 1, 2)
        mainLayout.addWidget(self.fb_on, 6, 2, 1, 2)
        mainLayout.addWidget(self.freq, 7, 0, 1, 4)
        mainLayout.addWidget(self.HD_Q, 8, 0, 1, 2)
        mainLayout.addWidget(self.HD_R, 8, 2, 1, 2)
        ...
        mainLayout.addWidget(self.dropdown_para, 10, 2, 1, 2)
    ...
    def linkfunction(self):
        ...
        self.dac_Vpi.le.editingFinished.connect(lambda: self.selectcontrolchangecolor(self.dac_Vpi.le))
        self.dac_Vpi.le.textChanged.connect(self.isdoubleForDAC_Vpi)
        self.dac_Vpi.le.setValidator(self.limite_doublevalidator)
        self.dac_Vpi_status = False

        self.rst_voltage.le.editingFinished.connect(lambda: self.selectcontrolchangecolor(self.rst_voltage.le))
        self.rst_voltage.le.textChanged.connect(self.isdoubleForRST_voltage)
        self.rst_voltage.le.setValidator(self.limite_doublevalidator)
        self.rst_voltage_status = False
    ...
    def controlchangewhite(self):
        ...
        self.dac_Vpi.le.setStyleSheet('background-color: white')

        self.rst_voltage.le.setStyleSheet('background-color: white')
    ...
    def getVersion(self):
        ...
        self.GUI_Version_lb.setText('MF-00-AR')
    ...
    def set_init_value(self, para):
        ...
        sf0_val = (para["SF0"] * 10000)
        sf1_val = (para["SF1"] * 10000)
        ...
        ## 20240417 修改
        # #將會有可能產生科學符號的部份，使用此方式將科學符號轉為標準表示法
        slope1_process = para["SFB_1_SLOPE"] * -1
        slope2_process = para["SFB_2_SLOPE"] * -1
        slope3_process = para["SFB_3_SLOPE"] * -1
        offset1_process = para["SFB_1_OFFSET"] * -1
        offset2_process = para["SFB_2_OFFSET"] * -1
        offset3_process = para["SFB_3_OFFSET"] * -1
    ...
    def loadTempandWriteBias(self):
        ...
        if filename != "":
            ...
            tempVal = biasData["TEMP Breakpoints"]
            slopeVal = biasData["slope"]
            offsetVal = biasData["offset"]
