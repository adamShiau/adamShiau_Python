...
class HinsConfigWidget(QWidget):
    ...
    def setup_ui(self):
        ...
        self.btn_set_data.clicked.connect(lambda: self.send_cmd("SET_DATA_5"))
    ...
    def send_cmd(self, cmd_name):
        ...
        cmd_map = {
            ...
            # 設定 10 Hz 吐出 GPS Timestamp (0xFF,0xD3) 與 GNSS Dual Antenna Status (0x82,0
            ...
            # 設定 10 Hz 吐出 GPS Timestamp (0xFF,0xD3)，GNSS Dual Antenna Status (0x82,0x49)與Status (0x82,0x10)
            "SET_DATA_2": [0xBC, 0xCB, 0x97, 0x14, 0x75, 0x65, 0x0C, 0x0E, 0x0E, 0x0F, 0x01, 0x82, 0x03, 0xD3, 0x00, 0x64,
                         0x49, 0x00, 0x64, 0x10, 0x00, 0x64, 0xEF, 0xC9, 0x51, 0x52],

            # 設定 10 Hz 吐出 GPS Timestamp (0xFF,0xD3)，GNSS Dual Antenna Status (0x82,0x49)，Status (0x82,0x10)
            # 與 Aiding Measurement Summary (0x82, 0x46)
            "SET_DATA_3": [0xBC, 0xCB, 0x97, 0x17, 0x75, 0x65, 0x0C, 0x11, 0x11, 0x0F, 0x01, 0x82, 0x04, 0xD3, 0x00, 0x64,
                           0x49, 0x00, 0x64, 0x10, 0x00, 0x64, 0x46, 0x00, 0x64, 0xA0, 0x42, 0x51, 0x52],

            # 設定 1 Hz 吐出 GPS Timestamp (0xFF,0xD3)，GNSS Dual Antenna Status (0x82,0x49)，Status (0x82,0x10)
            # 與 Aiding Measurement Summary (0x82, 0x46)
            "SET_DATA_4": [0xBC, 0xCB, 0x97, 0x17, 0x75, 0x65, 0x0C, 0x11, 0x11, 0x0F, 0x01, 0x82, 0x04, 0xD3, 0x03, 0xE8,
                           0x49, 0x03, 0xE8, 0x10, 0x03, 0xE8, 0x46, 0x03, 0xE8, 0xBC, 0xE8, 0x51, 0x52],

            # 設定 5 Hz 吐出 GPS Timestamp (0xFF,0xD3)，GNSS Dual Antenna Status (0x82,0x49)，Status (0x82,0x10)
            # 與 Aiding Measurement Summary (0x82, 0x46)
            "SET_DATA_5": [0xBC, 0xCB, 0x97, 0x17, 0x75, 0x65, 0x0C, 0x11, 0x11, 0x0F, 0x01, 0x82, 0x04, 0xD3, 0x00, 0xC8,
                           0x49, 0x00, 0xC8, 0x10, 0x00, 0xC8, 0x46, 0x00, 0xC8, 0x30, 0xDA, 0x51, 0x52],
