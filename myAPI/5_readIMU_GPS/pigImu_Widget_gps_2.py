...
class pigImuWidget(QWidget):
    ...
    def initUI(self):
        ...
        self.buffer_lb = displayOneBlock('Buffer Size_SP9')
        self.buffer_lb_2 = displayOneBlock('Buffer Size_SP10')
        self.buffer_lb_3 = displayOneBlock('Buffer Size_SP11')
        self.pd_temp_lb = displayOneBlock('PD Temp_SP9')
        self.pd_temp_lb_2 = displayOneBlock('PD Temp_SP10')
        self.pd_temp_lb_3 = displayOneBlock('PD Temp_SP11')
        self.data_rate_lb = displayOneBlock('Data Rate_SP9')
        self.data_rate_lb_2 = displayOneBlock('Data Rate_SP10')
        self.data_rate_lb_3 = displayOneBlock('Data Rate_SP11')
