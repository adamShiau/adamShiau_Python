...
class pgGraph_1_3(QMainWindow):
    def __init__(self, color1="W", color2="r", color3="y", width1=1, width2=1, width3=1, linename1="line 1", linename2="line 2", linename3="line 3", title="add title"):
