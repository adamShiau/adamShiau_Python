...
class kalman_1D:
    ...
    def __init__(self, x0=0, p0=0, Q=1, R=1):
        ...
        self.__kal_Q = Q
        self.__kal_R = R
        logProcess.checkInfoDebug(logName=logger_name, content=f"init Q = {self.kal_Q}", fileName=ExternalName_log)
        logProcess.checkInfoDebug(logName=logger_name, content=f"init R = {self.kal_R}", fileName=ExternalName_log)
