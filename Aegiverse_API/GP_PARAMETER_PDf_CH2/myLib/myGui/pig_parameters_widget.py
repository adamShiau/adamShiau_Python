...
class pig_parameters_widget(QGroupBox):
    def __init__(self, act, fileName="default_fog_parameters.json"):
        ...
        self.err_th = spinBlock(title='ERR_TH', minValue=-10000, maxValue=16384, double=False, step=1)
        ...
        self.HD_R = spinBlock(title='FPGA_R', minValue=-100000, maxValue=100000, double=False, step=1)
