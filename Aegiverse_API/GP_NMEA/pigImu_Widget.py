...
class pigImuWidget(QWidget):
    ...
    def initUI(self):
        ...
        self.heading_lb = displayOneBlock('Heading Angle [Degree]')
        ...
        self.plot1_unit_rb.setEnabled(False)
        # self.plot1 = pgGraph_1_2(color1="w", color2="r", title="FOG")
        self.plot2 = pgGraph_1(color=(255, 0, 0), title="Heading Angle [Degree]")
        ...
        layout.addWidget(self.heading_lb, 1, 5, 1, 1)
        ...
        layout.addWidget(self.plot2, 2, 0, 10, 20)
