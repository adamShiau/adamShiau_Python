...
class pigImuWidget(QWidget):
    ...
    def initUI(self):
        ...
        self.pdZ_temp_lb = displayOneBlock('PD Temp Z-Axis.')
        ...
        layout.addWidget(self.pdX_temp_lb, 1, 4, 1, 1)
        layout.addWidget(self.pdY_temp_lb, 1, 5, 1, 1)
        layout.addWidget(self.pdZ_temp_lb, 1, 6, 1, 1)
