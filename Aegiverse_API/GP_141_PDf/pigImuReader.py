...
POS_ROW = POS_PITCH + SIZE_4
POS_YAW = POS_ROW + SIZE_4
...
class pigImuReader(QThread):
    ...
    def getImuData(self):
        ...
        TIME, WX, WY, WZ, AX, AY, AZ, PD_TEMP, PITCH, ROW, YAW = cmn.readMP_1Z_ATT(dataPacket, POS_WX, POS_WY, POS_WZ, POS_AX, POS_AY,
                                                              POS_AZ, POS_MCUTIME, POS_PD_TEMP, POS_PITCH, POS_ROW,
                                                            POS_YAW, 4, PRINT=0)
