...
class pig_menu_manager:
    ...
    def action_list(self, obj):
        ...
        # 軟體版號顯示
        self.pig_version_action = QAction("pig version", obj)
        self.pig_version_action.setShortcut("Ctrl+Q")
        ...
        self.setting_menu.addAction(self.pig_version_action)
    ...
    def action_trigger_connect(self, fn):
        ...
        self.pig_version_action.triggered.connect(fn[5])
    ...
    def version_setEnable(self, open):
