...
class pgGraph_1_3(QMainWindow):
    def __init__(self, color1="w", color2="w", color3="w", width1=1, width2=1, width3=1, linename1="line 1", linename2="line 2", linename3="line 3" , title="add title"):
        ...
        # 畫粗的線條
        # self.ax1.setPen(width=5)
        # self.ax2.setPen(width=5)
        # self.ax3.setPen(width=5)

        # lineName_1 = pg.LegendItem()
        # lineName_2 = pg.LegendItem()
        # lineName_3 = pg.LegendItem()
        # # 線名稱字的大小設定
        # lineName_1.setLabelTextSize("12pt")
        # lineName_2.setLabelTextSize("12pt")
        # lineName_3.setLabelTextSize("12pt")
        #
        # lineName_1.addItem(self.ax1, linename1)
        # lineName_2.addItem(self.ax2, linename2)
        # lineName_3.addItem(self.ax3, linename3)
        #
        # win.addItem(lineName_1)
        # win.addItem(lineName_2)
        # win.addItem(lineName_3)
        self.setCentralWidget(win)
