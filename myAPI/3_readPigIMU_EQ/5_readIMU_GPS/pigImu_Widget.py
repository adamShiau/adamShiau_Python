...
class pigImuWidget(QWidget):
    ...
    def initUI(self):
        ...
        self.para_block = lineEditBlock(name='parameter configuration file', le_name="parameters_SP")
        ...
        layout.addWidget(self.date_rb, 3, 0, 1, 2)
        layout.addWidget(self.kal_filter_rb, 0, 4, 1, 1)
        layout.addWidget(self.gpstime_lb, 2, 2, 2, 8)
